...
class MedaniaGrafica(PersonajeGrafico):
    ...
    def __init__(self, x, y, modelo_medania):
        ...
        # ANIMACIONES
        # =========================
        self.cargar_animacion("idle", "src/assets/images/personajes/enemigos/medania/medania-idle.png", 2, 150, 150)
        self.cargar_animacion("attack", "src/assets/images/personajes/enemigos/medania/medania-attack.png", 8, 150, 150)
        self.cargar_animacion("death", "src/assets/images/personajes/enemigos/medania/medania-death.png", 6, 150, 150)
